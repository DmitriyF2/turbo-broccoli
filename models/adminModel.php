...
class adminModel extends Model {
  public $maxNotes = 10; // КОЛИЧЕСТВО СТРАНИЦ таблицы АДМИН
...
$a = $url[3];
   ...
   public static function category_minus1() {
...
/*  UPDATE `category`, `goods`, `base`
  INNER JOIN category on base.id_category = category.nameCat
  INNER JOIN goods on base.id_goods = goods.name
  SET category.activity =  171 */


public static function Update3($idB, $nameCat, $nameGood , $idCat, $idGood, $activity, $activityG, $short_description, $full_description, $quantity, $disposal) { ///обновление данных о товаре и группе

$db = dataBase::DB_connection();
//////////////////////////////////////////////////  id_category  //////

  $sql = "UPDATE `category`, `goods`, `base` SET id_category=:name_bind, id_goods=:nameG_bind, activity=:Act_bind, activityG=:ActG_bind, short_description=:ShDisc_bind, full_description=:FlDisc_bind, quantity=:Quant_bind, disposal=:Disp_bind  WHERE category.idCat=:id_bind AND goods.idG=:idG_bind AND base.idB=:idB_bind";
    $stmt = $db->prepare($sql);
