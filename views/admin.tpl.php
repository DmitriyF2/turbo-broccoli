...
th:hover {
	...
	td:hover {
			background:#CCCCFF; /* Цвет фона под ссылкой */
			color: #ffe; /* Цвет ссылки */
		 }
...
<body>
<header>
	<div class="logo-form" style="padding-left: 1em;text-align:left; position: absolute; left: 0em; top: 0em; right: 0em; background:#FFCCCC; height: 3em; animation: 1s ease slideInFromLeft; z-index: 2">
		<div id="logo">
			<p><a href="http://catalog-site.ru/admin/"><img src="img/logo1.png" class="logotip" alt="Logo-Company"></p></a>
		</div>
	</div>
</header>
